...
const updateNotes = notes => {
  const currentNoteState = document.querySelector($NOTES_TEXTAREA).value ? JSON.parse(document.querySelector($NOTES_TEXTAREA).value) : {};
  const {
    mode,
    date,
    time
